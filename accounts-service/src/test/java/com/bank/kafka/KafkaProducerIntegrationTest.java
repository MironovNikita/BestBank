...
@EmbeddedKafka(partitions = 3, topics = "accounts-notifications", brokerProperties = {"listeners=PLAINTEXT://localhost:9092", "port=9092"})
...
public class KafkaProducerIntegrationTest {
    ...
    private static final String TOPIC = "accounts-notifications";
    ...
    static void dynamicProperties(DynamicPropertyRegistry registry) {
        registry.add("spring.kafka.topic.notification", () -> "accounts-notifications");
    }
