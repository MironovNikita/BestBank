...
public class NotificationsServiceImpl implements NotificationsService {
    ...
    public Mono<Void> sendTransferNotification(String email, String subject, String text) {
        ...
        return Mono.fromFuture(() -> kafkaTemplate.send(notificationTopic, emailDto).toCompletableFuture())
                ...
                .doOnError(e -> log.error("Ошибка отправки уведомления на {}: {}", email, e.getMessage()))
                .then();
    }
}
