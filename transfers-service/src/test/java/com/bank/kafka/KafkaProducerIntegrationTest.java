...
@EmbeddedKafka(partitions = 3, topics = "transfers-notifications", brokerProperties = {"listeners=PLAINTEXT://localhost:9092", "port=9092"})
@SpringBootTest(classes = {NotificationsServiceImpl.class, KafkaProducerConfig.class, Resilience4jConfig.class, TestResilience4jConfig.class})
@ActiveProfiles("test")
public class KafkaProducerIntegrationTest {
    ...
    private static final String TOPIC = "transfers-notifications";
    ...
    void shouldSendEmailNotificationSuccessfully() throws InterruptedException {
        ...
        notificationsService.sendTransferNotification(emailTo, subject, text).block();
